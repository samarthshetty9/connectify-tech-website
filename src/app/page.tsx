      ...
      <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center pt-28 pb-24">
          ...
          <motion.h1
            ...
            className="text-[clamp(2.5rem,6vw,5.5rem)] font-extrabold leading-[1.08] tracking-tight mb-7"
          >
          ...
          >
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-gradient-to-r from-accent-blue to-accent-purple text-white font-semibold text-sm hover:shadow-xl hover:shadow-accent-blue/20 transition-all duration-300"
            >
              Get Started
            ...
            <Link
              href="/case-studies"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl glass text-white font-semibold text-sm hover:bg-white/[0.07] transition-all duration-300"
            >
              View Our Work
            </Link>
          </motion.div>
        ...
        <div className="animate-marquee">
          {[...services, ...services, ...services].map((s, i) => (
            <div key={i} className="flex items-center gap-2.5 px-6 shrink-0">
              ...
              <span className="text-xs font-medium text-gray-500 whitespace-nowrap uppercase tracking-wider">
                {s.name}
              </span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div>
              <SectionHeader
                label="Who We Are"
                title="Our Approach is Simple Yet Powerful."
                centered={false}
              />
              <FadeIn>
                <p className="text-gray-400 leading-relaxed mb-5">
                  At Connectify, we&apos;re not just building tech — we&apos;re building
                  possibilities. Since 2019, we&apos;ve worked across industries like
                  fintech, edtech, healthtech, constructiontech, mobility, and
                  more.
                </p>
                <p className="text-gray-400 leading-relaxed mb-8">
                  Our approach is simple: listen closely, understand your needs,
                  and create technology that actually works for you.
                </p>
                <Link
                  href="/about"
                  className="inline-flex items-center gap-2 text-accent-blue hover:text-accent-cyan transition-colors text-sm font-medium"
                >
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <SectionHeader
            ...
            subtitle="From ideation to deployment, we deliver comprehensive technology solutions across the entire digital spectrum."
          />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            {services.map((s, i) => (
              <FadeIn key={i} delay={i * 0.04}>
                <Link
                  href="/services"
                  className="glass rounded-xl p-5 text-center group hover:bg-white/[0.05] transition-all duration-300 block"
                >
                  <s.icon
                    size={22}
                    className="mx-auto mb-2.5 text-gray-500 group-hover:text-accent-blue transition-colors"
                  />
                  <p className="text-xs font-medium text-gray-400 group-hover:text-white transition-colors leading-tight">
                    {s.name}
                  </p>
                </Link>
              </FadeIn>
      ...
      <section className="py-20 lg:py-28 mesh-gradient">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <SectionHeader
            ...
            subtitle="Explore how we've helped businesses across fintech, mobility, healthcare, and more."
          />
            ...
            {featuredStudies.map((study, i) => (
              <FadeIn key={study.slug} delay={i * 0.06}>
                <Link
                  ...
                  className="glass rounded-xl overflow-hidden group hover:bg-white/[0.05] transition-all duration-300 block"
                >
                  <div
                  ...
                  <div className="p-5">
                    <span className="inline-block px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-accent-blue/10 text-accent-blue border border-accent-blue/20 mb-2.5">
                      {study.category}
                    </span>
          ...
          <FadeIn className="text-center mt-10">
            <Link
              href="/case-studies"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl glass text-white text-sm font-semibold hover:bg-white/[0.07] transition-all duration-300"
            >
