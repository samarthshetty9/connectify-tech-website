            ...
            <section className="max-w-3xl mx-auto px-6 lg:px-8 pb-20">
                <div className="space-y-10">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2.5">
                            <span className="w-6 h-0.5 bg-accent-blue rounded" />
                            Overview
                        </h2>
                    ...
                    <div className="glass rounded-xl p-6">
                        <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2.5">
                            <span className="w-6 h-0.5 bg-red-500 rounded" />
                            The Challenge
                        </h2>
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2.5">
                            <span className="w-6 h-0.5 bg-accent-purple rounded" />
                            Tech Stack
                        </h2>
                        <div className="flex flex-wrap gap-2">
                            {study.techStack.map((tech) => (
                                <span key={tech} className="px-3 py-1.5 rounded-lg glass text-xs font-medium text-gray-400">
                                    {tech}
                                </span>
                            ))}
                        </div>
                ...
                <div className="mt-16 pt-8 border-t border-white/[0.04] grid grid-cols-2 gap-4">
                    <Link
                        ...
                        className="glass rounded-xl p-4 group hover:bg-white/[0.05] transition-all"
                    >
                        <span className="text-[10px] text-gray-600 uppercase tracking-wider flex items-center gap-1 mb-1">
                            <ArrowLeft size={10} /> Previous
                        </span>
                        <span className="text-sm text-white font-medium group-hover:text-accent-blue transition-colors">
                            {prev.title}
                        </span>
                    </Link>
                    <Link
                        href={`/case-studies/${next.slug}`}
                        className="glass rounded-xl p-4 group hover:bg-white/[0.05] transition-all text-right"
                    >
